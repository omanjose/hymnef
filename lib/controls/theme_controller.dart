...
ThemeMode get themeStateFromSettingBox=>_getThemeFromHiveBox()?ThemeMode.dark:ThemeMode.light;
@override
  void onInit() {
...
bool _getThemeFromHiveBox(){
  themeHiveSetting= settingsHiveBox.get('isDarkMode',defaultValue:Get.isDarkMode );
